<template>
  <section class="sp">
      <img src="../img/sp.png" alt="" class="sp__img">
      <h1 class="sp__title">Become a Superpeer</h1>
      <button class="v-btn v-btn_p sp__btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="16" height="16" fill="white"/>
      ...
      <img src="../img/introbg.png" alt="" class="sp__bg">
  </section>
</template>
