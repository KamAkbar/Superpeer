<template>
  <div class="header container">
      ...
      <nav class="nav" :class="isOpen ? 'active' : ''">
          <a href="#" class="nav__item">HOME</a>
          <a href="#" class="nav__item">FEATURES</a>
          <a href="#" class="nav__item">ABOUT US</a>
          <h1 @click="showNav()" class="header__close">+</h1>
      </nav>
      <div class="header-details">
          <h4 class="header__log">SIGN IN</h4>
          <button class="v-btn v-btn_p header__btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="16" height="16" fill="white"/>
            ...
            </svg>BECOME A SUPERPEER</button>
      </div>
      <svg @click="showNav()" class="header__burger" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M24 48C37.2548 48 48 37.2548 48 24C48 10.7452 37.2548 0 24 0C10.7452 0 0 10.7452 0 24C0 37.2548 10.7452 48 24 48Z" fill="#FBD34B"/>
