<template>
  <section class="intro">
      <div class="intro-details">
          ...
          <p class="intro__text">Superpeer is an all-in-one video platform that gives you the tools you need to engage with your audience through video, and connect in a more authentic way.</p>
      </div>
      <button class="v-btn v-btn_p intro__btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="16" height="16" fill="white"/>
        ...
        <div class="intro-img">
            <img src="../img/intro.png" alt="" class="intro__img">
        </div>
      <img src="../img/introbg.png" alt="" class="intro__bg">
  </section>
</template>
...
<style lang="scss">
    ...
    .intro{
        ...
        &__bg{
            ...
            z-index: -1;
            left: 0;
            animation: circleScale 5s linear 0s infinite normal none;
            width: 100%;
        }
        &-details{
            display: flex;
